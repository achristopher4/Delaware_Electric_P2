...
Client_ID TEXT PRIMARY KEY, Name TEXT, Street_Address TEXT, City TEXT,
...
Campus_ID TEXT PRIMARY KEY, Name TEXT, Street_Address TEXT, City TEXT,
State TEXT, Zip INT, Country TEXT, Hours TEXT, Type TEXT, Description TEXT)
''')

## Employee
c.execute(''' CREATE TABLE IF NOT EXISTS Employee (
Employee_ID TEXT PRIMARY KEY, Manager_ID TEXT, Campus_ID TEXT, First_Name TEXT,
...
Employee_Photo_ID TEXT PRIMARY KEY, Server TEXT, Company_Name TEXT, Campus_ID TEXT,
Employee_ID,
FOREIGN KEY (Campus_ID) REFERENCES Campus(Campus_ID),
...
Supplier_ID TEXT PRIMARY KEY, Name TEXT, Phone_Number TEXT, Street_Address TEXT,
...
Inventory_ID TEXT PRIMARY KEY, Name TEXT, Supplier_ID TEXT, Campus_ID TEXT, Cost REAL,
...
Inventory_Photo_ID TEXT PRIMARY KEY, Server TEXT, Company_Name TEXT, Campus_ID TEXT,
Inventory_ID TEXT,
FOREIGN KEY(Campus_ID) REFERENCES Campus(Campus_ID),
...
Equipment_ID TEXT PRIMARY KEY, Campus_ID TEXT, Name TEXT, Make TEXT, Model TEXT,
...
Equipment_Photo_ID TEXT PRIMARY KEY, Equipment_ID TEXT, Server TEXT, Company_Name TEXT, Campus_ID TEXT,
FOREIGN KEY (Campus_ID) REFERENCES Campus(Campus_ID),
...
Sales_ID TEXT PRIMARY KEY, Client_ID TEXT, Inventory_ID TEXT, Employee_ID TEXT,
...
Job_ID TEXT PRIMARY KEY, Campus_ID TEXT, Client_ID TEXT, Type TEXT,
...
Task_ID TEXT PRIMARY KEY, Job_ID TEXT, Inventory_ID TEXT, Employee_ID TEXT, Campus_ID TEXT,
...
Task_Photo_ID TEXT PRIMARY KEY, Server TEXT, Company_Name TEXT, Campus_ID TEXT,
...
Employee_Time_Clock_ID TEXT PRIMARY KEY, Employee_ID TEXT, Year INT, Week INT, Day INT, Start_Time DATE,
